      ...
      <GlassCard style={styles.lockCard}>
        <View style={styles.lockCardInner}>
          <View style={styles.lockIconBg}>
            <FontAwesome5 name={item.app.iconName as any} size={22} color="#F5A94E" />
          </View>
    ...
    <GlassCard style={styles.emptyCard} padding={32}>
      <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
        <View style={styles.emptyIconBox}>
          <Feather name="unlock" size={32} color="#F5A94E" />
        </View>
      </Animated.View>
      ...
      >
        ...
        <Animated.View style={[styles.header, { transform: [{ translateY: headerY }], opacity: headerOpacity }]}>
          ...
          <View style={styles.shieldBadge}>
            <View style={[styles.shieldCircle, { backgroundColor: displayItems.length > 0 ? "#F5A94E" : "#2C2C2E" }]}>
        ...
        <View style={styles.statsRow}>
          <StatCard value={locks.length} label={t("locks")} color="#F5A94E" />
        ...
        <View style={styles.sectionRow}>
          <Feather name="lock" size={15} color="#F5A94E" />
...
const styles = StyleSheet.create({
  ...
  shieldBadge: { shadowColor: "#F5A94E", shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.35, shadowRadius: 12, elevation: 8 },
  ...
  ctaBtn: {
    ...
    shadowColor: "#F5A94E", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 14, elevation: 10,
  },
  ...
  countBadge: { backgroundColor: "#F5A94E", paddingHorizontal: 10, paddingVertical: 3, borderRadius: 12, minWidth: 24, alignItems: "center" },
  ...
  lockIconBg: { width: 50, height: 50, borderRadius: 16, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(245,169,78,0.1)" },
  lockInfo: { flex: 1, gap: 4 },
  lockAppName: { fontSize: 16, fontFamily: "Inter_700Bold", color: "#FFFFFF" },
  lockRemaining: { fontSize: 13, fontFamily: "Inter_400Regular", color: "#F5A94E" },
  ...
  emptyIconBox: { width: 72, height: 72, borderRadius: 24, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(245,169,78,0.1)" },
